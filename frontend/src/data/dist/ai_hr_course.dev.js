  ...
  }, // === FINAL ASSESSMENT (ALL 10 QUESTIONS) ===
  {
    ...
    lessons: [{
      ...
      questions: [{
        ...
        options: ["To replace HR professionals", "To support HR tasks using instructions", "To make legal decisions", "To eliminate human judgment"],
        answer: 1 // Answer: B

      }, {
        question: "In HR, a 'prompt' is best described as:",
        options: ["An employee record", "A policy document", "An instruction given to an AI system", "A payroll report"],
        answer: 2 // Answer: C

      }, {
        question: "Which HR activity can AI assist with using prompts?",
        options: ["Final hiring decisions", "Legal dispute resolution", "Drafting job descriptions", "Employee termination approvals"],
        answer: 2 // Answer: C

      }, {
        question: "Why must AI-generated job descriptions be reviewed by HR?",
        options: ["AI writes very slowly", "AI may introduce bias or errors", "AI cannot generate text", "AI does not follow formatting"],
        answer: 1 // Answer: B

      }, {
        question: "How can AI support resume screening?",
        options: ["By rejecting all candidates", "By conducting interviews", "By summarizing and highlighting key skills", "By making final hiring decisions"],
        answer: 2 // Answer: C

      }, {
        question: "Which task should always remain a human responsibility?",
        options: ["Drafting emails", "Creating interview questions", "Final performance evaluation decisions", "Summarizing feedback"],
        answer: 2 // Answer: C

      }, {
        question: "What is a key ethical concern when using AI in HR?",
        options: ["Faster processing", "Reduced paperwork", "Bias and fairness", "Improved documentation"],
        answer: 2 // Answer: C

      }, {
        question: "What type of data must be handled carefully?",
        options: ["Marketing data", "Financial stock data", "Employee personal and sensitive data", "Website analytics"],
        answer: 2 // Answer: C

      }, {
        question: "How can AI help in employee engagement?",
        options: ["Monitoring employees secretly", "Automatically promoting employees", "Creating and summarizing engagement surveys", "Issuing warnings"],
        answer: 2 // Answer: C

      }, {
        question: "What is important for successful AI adoption?",
        options: ["Full automation without oversight", "No employee communication", "Training HR staff and continuous monitoring", "Avoiding policies"],
        answer: 2 // Answer: C
...
exports.aiHrCourseData = aiHrCourseData;
//# sourceMappingURL=ai_hr_course.dev.js.map
