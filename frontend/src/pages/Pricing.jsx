        ...
        <div className="container mx-auto px-6 max-w-3xl">
          ...
          <div className="space-y-6">
            {[
              ...
              { q: "Can I upgrade later?", a: "Yes. If you buy a single course and decide to upgrade to the bundle later, contact support for a discount." },
              { q: "Do you offer refunds?", a: "We offer a 7-day money-back guarantee if you have completed less than 30% of the course." },
